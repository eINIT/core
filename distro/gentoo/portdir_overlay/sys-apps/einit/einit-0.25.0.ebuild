...
IUSE="doc static debug nowtf externalise fbsplash dbus noxml baselayout2"
...
PDEPEND="!noxml? ( >=sys-apps/einit-modules-xml-0.70.0 )"
...
src_compile() {
	local myconf
        ...
        myconf="--ebuild --prefix=/ --with-expat=/usr/lib/libexpat.a --libdir-name=$(get_libdir)"
