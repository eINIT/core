...
extern "C" {
     ...
     */
#define XML_TOK_TRAILING_RSQB -5        /* ] or ]] at the end of the scan; 
                                         * might be start of illegal ]]>
                                         * sequence */
    /*
...
#define XML_TOK_TRAILING_CR -3  /* A CR at the end of the scan; might be
...
#define XML_ENTITY_VALUE_LITERAL 1
    ...
    /*
     * The size of the buffer passed to XmlUtf8Encode must be at least
     * this. 
     */
#define XML_UTF8_ENCODE_MAX 4
    /*
     * The size of the buffer passed to XmlUtf16Encode must be at least
     * this. 
     */
...
#define XmlUtf16Convert(enc, fromP, fromLim, toP, toLim) \
  (((enc)->utf16Convert)(enc, fromP, fromLim, toP, toLim))
    ...
    int XmlInitEncoding(INIT_ENCODING *, const ENCODING **,
                        const char *name);
    ...
    int XmlInitEncodingNS(INIT_ENCODING *, const ENCODING **,
                          const char *name);
